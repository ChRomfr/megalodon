...
class adLDAP {
    ...
    * @var string
    */  
    //protected $accountSuffix = "@domaineb"; 
    ...
    * @var array
    */
    //protected $domainControllers = array("srv-ad1.domaineb","srv-ad2.domaineb");
    ...
    * @var string
    */
	//protected $adminUsername = 'ops';
    //protected $adminPassword = 'Tpal01';
