{strip}
<h5><strong>{if !empty($contact.raison_social)}{$contact.raison_social}{else}{$contact.prenom}&nbsp;{$contact.nom}{/if}</strong></h5>
...
<div class="text-center">
	<a href="{$Helper->getLink("contacts/detail/{$contact.id}}")}" title="Voir la fiche" class="btn btn-default">Fiche</a>
</div>	
