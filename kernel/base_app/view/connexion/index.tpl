				...
				<div class="row">
					<div class="col-md-4">
						...
						<div class="input-group">
							...
							<input autofocus type="text" name="login[identifiant]" id="identifiant" required class="form-control" />
						</div>
					</div><!-- /span4 -->
					<div class="col-md-4">
						...
						<div class="input-group">
							...
							<input type="password" name="login[password]" id="password" required class="form-control"/>
						</div>
